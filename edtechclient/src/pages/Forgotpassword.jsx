            ...
            <p>
                {
                 ...
                 <p>kindly check your E-mail</p> </p>
        ...
        
            {
              !emailsend && (
                 ...
                 <div className='flex flex-col space-y-5 mt-2 items-center'>
                    ...
                    <input className='p-3 rounded-lg w-80  text-blue-600 font-bold'
                      required
                     type="email"
                     name='email'
                     value={email}
              ...
              <button className='p-2 lg:w-48 mt-3 bg-yellow-400 text-black rounded-lg '
                type='submit'>
                 {
